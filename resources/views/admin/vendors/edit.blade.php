                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">   تعديل - {{ $vendors -> name }} </h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('admin.vendors.update', $vendors -> id)}}" method="POST"
                                                    ...
                                                    <div class="row">
                                                                    ...
                                                                    <optgroup label="من فضلك أختر القسم ">
                                                                        @if($categories && $categories -> count() > 0)
                                                                            @foreach($categories as $category)
                                                                                <option
                                                                                    value="{{$category -> id }}" @if ($vendors -> category_id == $category -> id)
                                                                                        selected
                                                        ...
                                                        <div class="col-md-6 ">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"  id="mobile" value="{{ $vendors -> mobile }}"
                                                                    class="form-control"
                                                                    placeholder=""
                                                                    name="mobile">
                                                                 @error("mobile")
                                                        ...
                                                        <div class="col-md-6 ">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"  id="email"
                                                                    class="form-control"
                                                                    placeholder="" value="{{$vendors -> email}}"
                                                                    name="email">
                                                                 @error("email")
                                                                <span class="text-danger">{{$message}}</span>
                                                                @enderror
                                                        ...
                                                        <div class="col-md-6 ">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"  id="pac-input"
                                                                    class="form-control"
                                                                    placeholder="" value="{{ $vendors -> address }}"
                                                                    name="address">
                                                                 @error("address")
                                                                <span class="text-danger">{{$message}}</span>
                                                                @enderror
...
@section('script')
    <script>
        ...
        function initAutocomplete() {
            var pos = {lat:   {{ $vendors->latitude }} ,  lng: {{ $vendors->longitude }} };
