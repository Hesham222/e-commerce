                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="name"
                                                                   ...
                                                                   name="categorey[0][name]">
                                                            @error("categorey.0.name")
                                                    ...
                                                    <div class="col-md-6 hidden">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="abbr"
                                                                   ...
                                                                   name="categorey[0][abbr]">

                                                            @error("categorey.0.abbr")
                                                            <span class="text-danger"> هذا الحقل مطلوب</span>
                                                            @enderror
                                                        </div>
                                                    </div>
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">تعديل - {{ $categories -> name }}
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row match-height">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{ route('admin.maincategories.update',$categories -> id) }}"
                                          method="POST"
                                          enctype="multipart/form-data">

                                    @csrf
                                    <input name="id" value="{{$categories -> id}}" type="hidden">

                                    <div class="form-group">
                                        <div class="text-center">
                                            <img src="{{ $categories -> photo }}" class="rounded-circle height-150" alt="صوره القسم">
                                        </div>
                                    </div>
                                        <div class="form-group">
                                            <label> صوره القسم </label>
                                        ...
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="ft-home"></i> بيانات  القسم </h4>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="projectinput1"> اسم القسم- {{__('messages.'.$categories -> translation_lang)}} </label>
                                                                <input type="text" id="name"
                                                                    class="form-control"
                                                                    placeholder=""
                                                        ...
                                                        <div class="col-md-6 hidden">
                                                            <div class="form-group">
                                                                <label for="projectinput1"> أختصار اللغة -  {{__('messages.'.$categories -> translation_lang)}}</label>
                                                                <input type="text"  id="name"
                                                                    class="form-control"
                                                                    placeholder=" "
                                                                    value="{{ $categories -> translation_lang }}"
                                                                    name="categorey[0][abbr]">
                                                                 @error("categorey.0.abbr")
                                                                <span class="text-danger"> هذا الحقل مطلوب</span>
                                                                @enderror
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group mt-1">
                                                                <input type="checkbox"  value="1" name="categorey[0][active]"
                                                                    id="switcheryColor4"
                                                                    class="switchery" data-color="success"
                                                                   @if($categories -> active == 1) checked @endif />
                                                                <label for="switcheryColor4"
                                                                    class="card-title ml-1">الحالة-  {{__('messages.'.$categories -> translation_lang)}} </label>
                                                                    @error("categorey.0.active")
                                                                    <span class="text-danger">هذا الحقل مطلوب </span>
                                                                    @enderror
                                                            </div>
