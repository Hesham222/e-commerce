                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="" id="name"
                                                                    class="form-control"
                                                                    placeholder=""
                                                                    name="categorey[{{ $index }}][name]">
                                                                    @error("categorey.$index.name")
                                                        ...
                                                        <div class="col-md-6 hidden">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"  id="name"
                                                                    ...
                                                                    placeholder=""
                                                                    value="{{ $lang -> abbr }}"
                                                                    name="categorey[{{ $index }}][abbr]">
                                                                 @error("categorey.$index.abbr")
                                                                <span class="text-danger"> هذا الحقل مطلوب</span>
                                                                @enderror
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group mt-1">
                                                                <input type="checkbox"  value="1" name="categorey[{{ $index }}][active]"
                                                                    id="switcheryColor4"
                                                                    class="switchery" data-color="success"
                                                                    checked/>
                                                                <label for="switcheryColor4"
                                                                    class="card-title ml-1">الحالة-  {{__('messages.'.$lang -> abbr)}} </label>
                                                                    @error("categorey.$index.active")
                                                                    <span class="text-danger">هذا الحقل مطلوب </span>
                                                                    @enderror
                                                            </div>
                                                        </div>
